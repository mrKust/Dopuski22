...
public class FileWork {
    ...
    public void write(int one, double two, double three) throws IOException {
        writer.print(one);
        writer.write(" ");
        writer.print(two);
        writer.write(" ");
    ...
    public void write(double lambda, double[] one, double[] two) throws IOException {
        writer.print(lambda);
        writer.write(" ");
        ...
        writer.println(two[two.length - 1]);
        writer.flush();
    }
